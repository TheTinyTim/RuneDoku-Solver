...
namespace RuneDoku_Solver
{
    public class SudokuBoard
    {
        ...
        {
            ResetSolutions();
            RuneDoku_Solver.Form1.SudokuProgress simplify = RuneDoku_Solver.Form1.SudokuProgress.PROGRESS;
            while (simplify == RuneDoku_Solver.Form1.SudokuProgress.PROGRESS) simplify = Simplify();

            if (simplify == RuneDoku_Solver.Form1.SudokuProgress.FAILED)
                yield break;
        ...
        internal RuneDoku_Solver.Form1.SudokuProgress Simplify()
        {
